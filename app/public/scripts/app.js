...
var _dateDisplay = __webpack_require__(4);
...
var _revealScroll = __webpack_require__(9);
...
new _revealScroll2.default((0, _jquery2.default)('.about__image'), '80%');
new _revealScroll2.default((0, _jquery2.default)('.about__panel'), '80%');
new _revealScroll2.default((0, _jquery2.default)('.links__section'), '70%');
...
var DateDisplay = function () {
    function DateDisplay() {
        ...
        this.date = new Date();
        this.dateDisplay = (0, _jquery2.default)('#dateDisplay');
        this.setDate();
    }
...
var RevealScroll = function () {
    function RevealScroll(els, offset) {
            ...
            this.revealItems.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        (0, _jquery2.default)(item).addClass('reveal-item--visible');
                    },
